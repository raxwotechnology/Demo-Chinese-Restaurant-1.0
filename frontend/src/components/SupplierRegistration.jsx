...
const SupplierRegistration = () => {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://demo-chinese-restaurant-1-0.onrender.com/api/auth/supplier/register",
        newSupplier,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://demo-chinese-restaurant-1-0.onrender.com/api/auth/supplier/${editingSupplier}`,
        editData,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`https://demo-chinese-restaurant-1-0.onrender.com/api/auth/supplier/${id}`, {
